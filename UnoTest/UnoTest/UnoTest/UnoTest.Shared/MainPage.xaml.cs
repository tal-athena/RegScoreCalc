...
namespace UnoTest
{
    ...
    public sealed partial class MainPage : Windows.UI.Xaml.Controls.Page
    {
        ...
        private async void OnExportToAccess(object sender, RoutedEventArgs e)
        {
            ...
            if (saveFile != null)
            {
                for (var i = 0; i < m_lstPdfInfos.Count; i ++)
                {
                    await Windows.Storage.FileIO.AppendTextAsync(saveFile, m_lstPdfInfos[i].Id.ToString() + "\n");
                }
