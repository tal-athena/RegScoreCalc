...
{
	public class PaneTabNotesCommandsFast : PaneCommands
	{
		#region Fields

		protected List<PaneNotes> _textBoxList;
		protected RibbonComboBox _cmbLineSpacing;

        protected List<PaneNotes> _extraTextBoxList;
        ...
        public PaneTabNotesCommandsFast(ViewsManager views, RibbonPanel panel, List<PaneNotes> _paneNotesList, List<PaneNotes> extraPaneNotesList = null) : base(views, panel)
		{
            _textBoxList = _paneNotesList;

            _extraTextBoxList = extraPaneNotesList;
