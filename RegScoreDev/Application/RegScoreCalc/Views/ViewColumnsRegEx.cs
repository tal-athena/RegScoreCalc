...
{
	public class ViewColumnsRegEx : View
	{
		#region Fields

		protected SplitContainer _splitter;

		protected PaneColumnsRegEx _paneRegExp;
		protected PaneDocuments _paneDocuments;
        //protected PaneColumnNotes _paneNotes;
        protected PaneRegTabNotes _paneTabNotes;
		...
		public ViewColumnsRegEx(ViewType viewtype, string strTitle, ViewsManager views, object objArgument)
		...
		protected override void InitViewPanes(RibbonTab tab)
		{
			...
			_paneRegExp = new PaneColumnsRegEx(_views);
			_paneRegExp._eventDataModified += new EventHandler(OnDataModified);
			_paneRegExp.ExtractFinished += i => _paneDocuments.ScrollToDynamicColumn(i);
            ...
            /*
			_paneNotes = new PaneColumnNotes();
			...
			_paneNotes.ShowPane();
            */
            _paneTabNotes = new PaneRegTabNotes();
		...
		public override void UpdateView()
		{
			if (_paneRegExp != null)
			{
				...
				if (_paneTabNotes != null)
				{
                    _paneTabNotes.SelectedColumnID = _paneRegExp.CurrentSelectedColumnID;
                    _paneTabNotes.UpdatePane();
		...
		public PaneColumnsRegEx GetPaneColumnsRegEx()
		{
			return _paneRegExp;
		}
