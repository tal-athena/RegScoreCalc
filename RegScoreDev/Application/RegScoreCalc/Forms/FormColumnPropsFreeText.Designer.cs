...
{
	partial class FormColumnPropsFreeText
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "This column type does not have any editable properties";
			this.label1.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// FormColumnPropsFreeText
			// 
			...
			this.Name = "FormColumnPropsFreeText";
