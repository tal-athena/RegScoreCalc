...
namespace System.Windows.Forms
{
        ...
        : Control
    {
		...
		public void CloseDropdowns(bool bCloseOrb)
		{
			try
			{
				if (this.OrbDropDown.Visible)
				{
					foreach (RibbonItem item in this.OrbDropDown.AllItems)
					{
						if (item is RibbonOrbMenuItem)
						{
							RibbonOrbMenuItem drp = (RibbonOrbMenuItem)item;
							if (drp.DropDown != null && drp.DropDownVisible)
								drp.CloseDropDown();
						}
					}
        ...
        {
			// MODIFIED: better mention author in aboutbox
